            ...
            <div class="nk-block-head nk-block-head-sm">
                <div class="nk-block-between g-3">
                    <div class="nk-block-head-content">
                        <h3 class="nk-block-title page-title">Chauffeur / {{ $traveller->name ?? "" }}</h3>
                    </div>
                    <div class="nk-block-head-content">
                        <a href="{{ route('admin.travellers.index') }}" class="btn btn-outline-light btn-sm bg-white d-none d-sm-inline-flex">
