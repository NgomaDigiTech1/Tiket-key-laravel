...
<head>
    ...
    <title>Contact Mail</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
                        ...
                        <tr>
                            <td>
                                <div class="text" style="padding: 0 3em; text-align: center;">
                                    <h2>Message de : {{$name}} - Mail {{$email}}</h2>
                                    <p>{{$messages}}</p>
                                    <p><a href="#" class="btn btn-primary">Phone : {{$phone}}</a></p>
                                </div>
                            </td>
                        </tr>
                    </table>
